...
ROUNDS_INTERVAL = 1 * 2.5 * 60  # interval between rounds, seconds
#DROP_WINDOW = 30 * 60  # drop window before each round_start, seconds
DROP_WINDOW = 1 * 60  # drop window before each round_start, seconds
#ROUND_TIME = 1 * 60 * 60  # round_start time, seconds
ROUND_TIME = 1 * 1 * 60  # round_start time, seconds
