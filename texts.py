WELCOME = '''Hello!'''
PERMISSION_ERROR = '''Sorry, you must be am admin to do this.'''
...
NEXT_ROUND = '''Next round starts at: '''
GIMME_UR_LINKS = '''Drop window started. Send your Instagram profiles into this chat if you want to participate this round.'''
